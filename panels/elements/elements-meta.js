...
const str_ = i18n.i18n.registerUIStrings(
    'panels/elements/elements-meta.ts',
    UIStrings
);
...
async function loadElementsComponentsModule() {
    if (!loadedElementsComponentsModule) {
        loadedElementsComponentsModule = await import(
...
UI.ViewManager.registerViewExtension({
    location:
        'elements-sidebar' /* UI.ViewManager.ViewLocationValues.ELEMENTS_SIDEBAR */,
    ...
    bindings: [
        {
            shortcut: 'Ctrl+Alt+C',
            platform:
                'windows,linux' /* UI.ActionRegistration.Platforms.WindowsLinux */,
        },
        {
            shortcut: 'Meta+Alt+C',
...
UI.ActionRegistration.registerActionExtension({
    ...
    category:
        'SCREENSHOT' /* UI.ActionRegistration.ActionCategory.SCREENSHOT */,
});
UI.ActionRegistration.registerActionExtension({
    category: '',
...
UI.ActionRegistration.registerActionExtension({
    ...
    iconClass:
        'select-element' /* UI.ActionRegistration.IconClass.LARGEICON_NODE_SEARCH */,
    bindings: [
        {
...
UI.Toolbar.registerToolbarItem({
    ...
    order: 1,
    location:
        'styles-sidebarpane-toolbar' /* UI.Toolbar.ToolbarItemLocation.STYLES_SIDEBARPANE_TOOLBAR */,
});
UI.Toolbar.registerToolbarItem({
    async loadItem() {
        const Elements = await loadElementsModule();
...
UI.Toolbar.registerToolbarItem({
    actionId: 'refresh-page',
    location:
        'main-toolbar-left' /* UI.Toolbar.ToolbarItemLocation.MAIN_TOOLBAR_LEFT */,
    order: 0,
});
// UI.Toolbar.registerToolbarItem({
//     actionId: 'elements.toggle-element-search',
