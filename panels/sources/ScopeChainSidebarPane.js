...
export class ScopeChainSidebarPane extends UI.Widget.VBox {
    ...
    createScopeSectionTreeElement(scope, extraProperties) {
        ...
        const section = new ObjectUI.ObjectPropertiesSection.RootElement(scope.object(), this.linkifier, emptyPlaceholder, 0 /* ObjectUI.ObjectPropertiesSection.ObjectPropertiesMode.All */, extraProperties);
